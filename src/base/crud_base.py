...
class CRUDBase:
    ...
    async def get_one_or_none(self, obj_id: int, session: AsyncSession) -> ModelType | None:
    ...
    async def create(self, data: CreateSchemaType, session: AsyncSession) -> ModelType:
    ...
    async def update(self, data: dict, obj_id: int, session: AsyncSession) -> None:
